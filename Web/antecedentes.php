    ...
    <header>
      <div class="nav-menu" id="menu">
          <div class="nav-container">
            <div class="nav-brand">
              <a href="index.html" class="brand"><img class="brand" src="img/cies.png" alt="cies logo" /></a>
            </div>
            <ul class="nav-bar">
              ...
              <li class="nav-item" ><a href="#contacto" id="nav-a">Contacto</a></li>
            </ul>
          </div>
      </div>
    </header>
        ...
        <div class="slider-carousel">
          <div class="item">
            <div class="item-container">
              ...
              <h5>ANTECEDENTES DEL ENCUENTRO</h5>
              <p>La Asociación de Por los Jóvenes del Club Rotario Morelia, en unión con el trabajo y empeño de las Universidades e Instituciones
          ...
          <div class="item">
            <div class="item-container">
              ...
              <h5>ENCUENTROS INTERUNIVERSITARIOS</h5>
          ...
          <div class="item">
            <div class="item-container">
              ...
              <h5>________</h5>
              <p>Fuimos juntos del miedo a la esperanza, de la esperanza al compromiso, del compromiso a la acción, y de la acción al cambio.
